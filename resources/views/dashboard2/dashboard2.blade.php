        ...
        <div class="card">
            <div class="container-fluid">
                <div class="form-head align-items-center d-flex mb-sm-4 mb-3">
                    ...
                    <div class="col-xl-3">
                        <div class="dropdown custom-dropdown">
                            <button type="button" class="btn btn-sm btn-primary btn-sm" data-toggle="dropdown">
                                <i class="ti-calendar m-r-5">  </i>  Desember 20, 2021 &nbsp; To &nbsp;April
                                20, 2023
                                <i class="fa fa-angle-down ml-3"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="#">  Desember 20, 2021 &nbsp; To &nbsp;April
                                    20, 2023</a>
                                <a class="dropdown-item" href="#">  Januari 20, 2021 &nbsp; To &nbsp; August
                                    20, 2022</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-header">
                    <h4 class="card-title">Dashboard Stok Bulan Desember</h4>
                    
                    <a href="javascript:void(0)" class="btn btn-primary mr-3 btn-sm" class="fa fa-shopping-cart" data-toggle="modal"
                        ...
                        <table class="table table-responsive-md">
                            <thead>
                                <tr>
                                    ...
                                    <th><strong>Jumlah Penerimaan Obat</strong></th>
                                    <th><strong>Tanggal Penerimaan</strong></th>
                                    <th><strong>Stok Bulan</strong></th>
                                    <th><strong>Total Pengeluaran Bulan Berjalan</strong></th>
                                    <th><strong>Jumlah Obat ED</strong></th>
                                    <th><strong>Sisa Stok</strong></th>
