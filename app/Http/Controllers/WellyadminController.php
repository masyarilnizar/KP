...
class WellyadminController extends Controller
{
    ...
    public function dashboard_2()
    {
        ...
        return view('dashboard2.dashboard2', compact('page_title', 'page_description','action'));
    }
	    // Datamaster
    public function obat()
    {
        ...
        return view('datamaster.obat', compact('page_title', 'page_description','action'));
    }
    ...
    public function golongan()
    {
        ...
        return view('datamaster.golongan', compact('page_title', 'page_description','action'));
    }
    ...
    public function kandungan()
    {
        ...
        return view('datamaster.kandungan', compact('page_title', 'page_description','action'));
    }
    ...
    public function dosis()
    {
        ...
        return view('datamaster.dosis', compact('page_title', 'page_description','action'));
    }
    ...
    public function satuan()
    {
        ...
        return view('datamaster.satuan', compact('page_title', 'page_description','action'));
    }
    ...
    public function pabrik()
    {
        ...
        return view('datamaster.pabrik', compact('page_title', 'page_description','action'));
    }
    ...
    public function pbf()
    {
        ...
        return view('datamaster.pbf', compact('page_title', 'page_description','action'));
    }
